...
```{r, cache=TRUE}
require('data.table');require('tidytext');require('magrittr');require(dplyr);require(dtplyr)
require("tibble");library("tm"); library("stringr")
```
...
test = mytokenization(fileinfo$files[4],5000)
